...
function CurveGraph({ steps, accent, hover, setHover, tempUnit }) {
  ...
  return (
    <div style={{
      ...
      boxShadow: 'inset 0 0 0 0.5px rgba(255,255,255,0.10), inset 0 1px 0 rgba(255,255,255,0.08), inset 0 -0.5px 1px rgba(0,0,0,0.4)',
    }}>
      <svg width="100%" viewBox={`0 0 ${W} ${H}`} style={{ display: 'block' }}>
        ...
        {pts.map((p, i) => (
          <g key={i} onMouseEnter={() => setHover(i)} onMouseLeave={() => setHover(null)} style={{ cursor: 'pointer' }}>
            ...
            <circle cx={p.x} cy={p.y} r={hover === i ? 5 : 4} fill="#fff"
